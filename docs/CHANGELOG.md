...
- pinned `package.json->devEngines->packageManager` to exact version, since corepack doesn't support semver, added added deterministic hash for security best practice
