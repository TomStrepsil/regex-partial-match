# Contributing to regex-partial-match
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/regex-partial-match.git
   cd regex-partial-match
   ```
...
1. **Search [existing issues](https://github.com/TomStrepsil/regex-partial-match/issues)** to see if your bug or feature has already been reported
2. **Check [open pull requests](https://github.com/TomStrepsil/regex-partial-match/pulls)** to avoid duplicate work
...
- Add tests that reproduce bugs before fixing them
