 ...
 *   - compilePartial result (plain RegExp, no class overhead)
...
const plainPartialPhone = staticPartial(phonePattern);
...
const plainPartialDate = staticPartial(datePattern);
